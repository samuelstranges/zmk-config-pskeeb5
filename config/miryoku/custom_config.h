...
U_HML(LCTRL, A),   U_HML(LALT, S),    U_HML(LSHFT, D),   U_HML(LGUI, F),    &kp G,             U_HMR(LGUI, H),    U_HMR(LSHFT, J),   U_HMR(LALT, K),    U_HMR(LCTRL, L),   &kp SEMICOLON,           \
...
&kp LCTRL,         &kp LALT,          &kp LSHFT,         &kp LGUI,          U_NA,              &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        U_EP_TOG,          \
...
&kp LCTRL,         &kp LALT,          &kp LSHFT,         &kp LGUI,          U_NU,              &kp LGUI,          &kp LSHFT,         &kp LALT,          &kp LCTRL,         U_NU,              \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
...
&kp ASTRK,         &kp N4,            &kp N5,            &kp N6,            &kp PLUS,        &kp LGUI,          &kp LSHFT,         &kp LALT,          &kp LCTRL,         U_NA,              \
...
&kp F11,           &kp F4,            &kp F5,            &kp F6,            &kp SLCK,          &kp LGUI,          &kp LSHFT,         &kp LALT,          &kp LCTRL,         U_NA,              \
